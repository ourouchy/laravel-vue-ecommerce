    ...
    <div class="bg-white p-4 rounded-lg shadow animate-fade-in-down">
        ...
        <table class="table-auto w-full">
            ...
            <tr>
                ...
                <TableHeaderCell @click="sortProduct" class="border-b-2 p-2 text-left" field="updated_at" :sort-field="sortField" :sort-direction="sortDirection">Updated At</TableHeaderCell>
